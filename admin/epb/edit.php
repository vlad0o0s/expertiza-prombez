    ...
    <div class="admin-content">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($epb['title']); ?>"
                    required>
            </div>
                ...
                <label for="slug">
                    ...
                    <span class="tooltip-icon">?
                        <span class="tooltip-text">Уникальный URL-адрес ЭПБ (например:
                            epb-pod-emnyh-sooruzheniy-i-kranov). Используйте только латинские буквы, цифры и
                            дефисы.</span>
                    </span>
                </label>
            ...
            <div class="form-group">
                ...
                <input type="text" id="category" name="category"
                    value="<?php echo htmlspecialchars($epb['category'] ?? ''); ?>" placeholder="Например: Э3">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="hero_image" name="hero_image"
                    value="<?php echo htmlspecialchars($epb['hero_image'] ?? ''); ?>">
                ...
                <div id="hero_image_preview"
                    style="margin-top: 10px; <?php echo !empty($epb['hero_image']) ? 'display: block;' : 'display: none;'; ?> position: relative;">
                    <div class="image-preview-wrapper">
                        <img id="hero_image_preview_img" src="<?php echo htmlspecialchars($epb['hero_image'] ?? ''); ?>"
                            alt="Превью"
            ...
            <div class="form-group">
                ...
                <textarea id="hero_content"
                    name="hero_content"><?php echo htmlspecialchars($epb['hero_content']); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="features_content"
                    name="features_content"><?php echo htmlspecialchars($epb['features_content']); ?></textarea>
            </div>
