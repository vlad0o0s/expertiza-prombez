        ...
        <form method="POST" action="" enctype="multipart/form-data">
                ...
                <label for="slug">
                    ...
                    <span class="tooltip-icon">?
                        <span class="tooltip-text">Уникальный URL-адрес статьи (например:
                            oboznacheniye-trass-polietilenovykh-gazoprovodov). Будет автоматически сгенерирован из
                            заголовка, если оставить пустым. Используйте только латинские буквы, цифры и дефисы.</span>
                    </span>
                </label>
            ...
            <div class="form-group">
                ...
                <select id="category" name="category">
                    ...
                    <option value="metallurgy" <?php echo (isset($_POST['category']) && $_POST['category'] === 'metallurgy') ? 'selected' : ''; ?>>ЭПБ МАТАЛЛУРГИЧЕСКИХ ПРОИЗВОДСТВ
                    </option>
                    ...
                    <option value="explosive-works" <?php echo (isset($_POST['category']) && $_POST['category'] === 'explosive-works') ? 'selected' : ''; ?>>ЭПБ ВЗРЫВНЫХ РАБОТ И МАТЕРИАЛОВ
                    </option>
                    <option value="oil-refining" <?php echo (isset($_POST['category']) && $_POST['category'] === 'oil-refining') ? 'selected' : ''; ?>>ЭПБ НЕФТЕПЕРЕРАБАТЫВАЮЩИХ И
                        НЕФТЕХИМИЧЕСКИХ ОБЪЕКТОВ</option>
                    <option value="mining" <?php echo (isset($_POST['category']) && $_POST['category'] === 'mining') ? 'selected' : ''; ?>>ЭПБ ГОРНОДОБЫВАЮЩИХ ОБЪЕКТОВ</option>
                    <option value="underground" <?php echo (isset($_POST['category']) && $_POST['category'] === 'underground') ? 'selected' : ''; ?>>ЭПБ ПОДЗЕМНЫХ ОБЪЕКТОВ И ТОННЕЛЕЙ
                    </option>
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt"
                    name="excerpt"><?php echo htmlspecialchars($_POST['excerpt'] ?? ''); ?></textarea>
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="header_image" name="header_image"
                    value="<?php echo htmlspecialchars($_POST['header_image'] ?? ''); ?>">
                ...
                <div id="header_image_preview" style="margin-top: 10px; display: none; position: relative;">
                    <div class="image-preview-wrapper">
                        <img id="header_image_preview_img" src="" alt="Превью"
            ...
            <div class="form-group">
                ...
                <textarea id="content"
                    name="content"><?php echo htmlspecialchars($_POST['content'] ?? ''); ?></textarea>
            </div>
