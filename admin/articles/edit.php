            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="slug">
                        URL (slug) *
                        <span class="tooltip-icon">?
                            <span class="tooltip-text">Уникальный URL-адрес статьи (например: oboznacheniye-trass-polietilenovykh-gazoprovodov). Используйте только латинские буквы, цифры и дефисы.</span>
                        </span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category">
                        ...
                        <option value="metallurgy" <?php echo ($article['category'] === 'metallurgy') ? 'selected' : ''; ?>>ЭПБ МАТАЛЛУРГИЧЕСКИХ ПРОИЗВОДСТВ</option>
                        <option value="energy" <?php echo ($article['category'] === 'energy') ? 'selected' : ''; ?>>ЭПБ ЭНЕРГЕТИЧЕСКИХ УСТАНОВОК И КОТЛОВ</option>
                        <option value="coal" <?php echo ($article['category'] === 'coal') ? 'selected' : ''; ?>>ЭПБ ОБЪЕКТОВ УГОЛЬНОЙ ПРОМЫШЛЕННОСТИ</option>
                        <option value="gas" <?php echo ($article['category'] === 'gas') ? 'selected' : ''; ?>>ЭПБ ГАЗОВОГО ОБОРУДОВАНИЯ И ГАЗОПРОВОДОВ</option>
                        <option value="flammable" <?php echo ($article['category'] === 'flammable') ? 'selected' : ''; ?>>ЭПБ ОБЪЕКТОВ С ГОРЮЧИМИ ЖИДКОСТЯМИ</option>
                        <option value="explosive" <?php echo ($article['category'] === 'explosive') ? 'selected' : ''; ?>>ЭПБ ОБЪЕКТОВ СО ВЗЫВЧАТАМИ ВЕЩЕСТВАМИ</option>
                        <option value="hazardous" <?php echo ($article['category'] === 'hazardous') ? 'selected' : ''; ?>>ЭПБ ОБЪЕКТОВ С ОПАСНЫМИ ВЕЩЕСТВАМИ</option>
                        <option value="pressure" <?php echo ($article['category'] === 'pressure') ? 'selected' : ''; ?>>ЭПБ ОБОРУДОВАНИЯ, РАБОТАЮЩЕГО ПОД ДАВЛЕНИЕМ</option>
                        <option value="lifting" <?php echo ($article['category'] === 'lifting') ? 'selected' : ''; ?>>ЭПБ ПОДЪЕМНЫХ СООРУЖЕНИЙ И КРАНОВ</option>
                        ...
                        <option value="mining" <?php echo ($article['category'] === 'mining') ? 'selected' : ''; ?>>ЭПБ ГОРНОДОБЫВАЮЩИХ ОБЪЕКТОВ</option>
                        <option value="underground" <?php echo ($article['category'] === 'underground') ? 'selected' : ''; ?>>ЭПБ ПОДЗЕМНЫХ ОБЪЕКТОВ И ТОННЕЛЕЙ</option>
                        <option value="pipelines" <?php echo ($article['category'] === 'pipelines') ? 'selected' : ''; ?>>ЭПБ ТРУБО- ГАЗО- НЕФТЕ-ПРОДУКТО- АММИАКО- ПРОВОДОВ</option>
                        <option value="storage" <?php echo ($article['category'] === 'storage') ? 'selected' : ''; ?>>ЭПБ ОБЪЕКТОВ ХРАНЕНИЯ НЕФТИ И ГАЗА</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="header_image" name="header_image" value="<?php echo htmlspecialchars($article['header_image'] ?? ''); ?>">
                    ...
                    <div id="header_image_preview" style="margin-top: 10px; <?php echo !empty($article['header_image']) ? 'display: block;' : 'display: none;'; ?> position: relative;">
                        <div class="image-preview-wrapper">
                            <img id="header_image_preview_img" src="<?php echo htmlspecialchars($article['header_image'] ?? ''); ?>" alt="Превью" style="max-width: 300px; max-height: 200px; border-radius: 5px; border: 1px solid #91A2B8; display: block;">
